...
fn setup_invoke_handlers(builder: tauri::Builder<tauri::Wry>) -> tauri::Builder<tauri::Wry> {
    builder.invoke_handler(tauri::generate_handler![
        ...
        crate::handlers::recognition::recognize_and_mark_videos,
        crate::handlers::recognition::build_recognition_dataset,
        crate::handlers::recognition::update_dataset_sample_label,
        crate::handlers::recognition::update_dataset_sample_phase,
        crate::handlers::recognition::update_dataset_sample_labels_bulk,
        crate::handlers::recognition::update_dataset_sample_phases_bulk,
        crate::handlers::recognition::export_recognition_dataset,
        crate::handlers::recognition::train_and_update_recognition_model,
        crate::handlers::recognition::start_recognition_training_task,
        crate::handlers::recognition::get_recognition_training_status,
        crate::handlers::recognition::stop_recognition_training,
